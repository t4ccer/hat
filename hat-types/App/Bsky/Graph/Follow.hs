...
follow'AesonFields (Follow createdAt subject) =
  mconcat
    [ Data.Aeson.Key.fromString "createdAt" Data.Aeson..= createdAt
    , Data.Aeson.Key.fromString "subject" Data.Aeson..= subject
    ]
